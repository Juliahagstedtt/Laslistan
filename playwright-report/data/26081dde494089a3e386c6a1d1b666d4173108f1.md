...
- Name: Katalog >> Som användare vill jag kunna favoritmarkera en bok genom att klicka på hjärtat.
...
Call log:
  - waiting for getByRole('button', { name: 'Favorit' })
    ...
    at C:\Users\46736\Desktop\Hemsidor\Skola\Testning\Laslistan\src\tests\katalog.spec.js:11:30
```
